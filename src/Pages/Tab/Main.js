...
import Image1 from "../../Assets/biryani (1).jpg";
import Image2 from "../../Assets/side-dish (3).jpg";
import Image3 from "../../Assets/healthy-traditional-indian-food..jpg";
...
const Main = () => {
    ...
    const [textItems, setTextItems] = useState([
        { id: 1, text: "This is my main page", left: 100, top: 100 },
        { id: 2, text: "If you want to explore more", left: 200, top: 150 },
        { id: 3, text: "You can click on Event, Our Story and Cart", left: 150, top: 200 },
        { id: 4, text: "Otherwise you can return", left: 250, top: 250 },
    ]);
    ...
    return (
        <DndProvider backend={deviceMode === 'mobile' ? TouchBackend : HTML5Backend}>
            <div className={`relative w-full h-screen ${deviceMode === 'mobile' ? 'bg-gray-100' : 'bg-white'}`}>
                <img
                    src={BackgroundImage}
                    alt="Background"
                    className={`absolute inset-0 w-full h-full object-cover ${deviceMode === 'mobile' ? 'opacity-50' : 'opacity-100'}`}
                />
                ...
                <div className={`absolute inset-0 grid grid-cols-1 ${deviceMode === 'mobile' ? 'grid-rows-1' : 'sm:grid-cols-2 lg:grid-cols-2'} gap-4 mt-20 p-4`}>
                    ...
                    <div className="relative">
                        <img src={BackgroundImage} alt="Image 3" className="w-full h-full object-cover rounded-lg" />
                    </div>
                </div>
